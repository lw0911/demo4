  ...
  $(function(){
      ...
      wow.init();
        ...
        //运营类型
      $('.type_list .type_item').hover(function(){
      ...
      $('.steward_server_list dl').hover(function(){
          $(this).addClass('active').siblings().removeClass('active');
      },function(){
          $(this).removeClass('active').siblings().removeClass('active');
      });
      ...
      $('.question_list .question_item_tit').on('click',function(){
            $(this).siblings('.question_item_answer').stop().slideToggle();
            $(this).closest('.question_item').siblings().find('.question_item_answer').slideUp();
      });
