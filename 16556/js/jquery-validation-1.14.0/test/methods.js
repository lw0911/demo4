...
test("iban", function() {
	...
	ok( method( "EE38 2200 2210 2020 5685"), "Valid IBAN - EE");
...
test("pattern", function() {
	...
	ok( method( "2020-10-02", "[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])" ), "Correct format for the given RegExp" );
	ok(!method( "02-10-2020", "[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])" ), "Invalid format for the given RegExp" );
});
