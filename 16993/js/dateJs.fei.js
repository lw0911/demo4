 ...
 * */
//日历最外层div样式
var outerStyle = "display: none;position: absolute;width: 440px;margin-top:10px;border: 1px solid #F7F7F7;border-radius: 5px;background-color: #F7F7F7;color: #4eccc4;padding-bottom: 20px;";
//日历控件最外层div
...
function createDate(thisYear, thisMonth) {
	...
	createDoc += '<p style="width: 100%;height: 30px;text-align: center;color: #999; line-height: 30px;" onclick="getThisDay()">当前日期 ' + nowYear + "年" + nowMonth + "月" + nowDay + "号";
	//关闭日历显示
